...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BambaRedKeep", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		app.meta.set("file", "BambaRedKeep");
		app.meta.set("name", "BambaRedKeep");
		app.meta.set("packageName", "com.sample.bambaredkeep");
