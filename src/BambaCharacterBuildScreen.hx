...
class BambaCharacterBuildScreen extends DisplayObject {
		...
		switch (currTabType) {
			...
			case 1:
				if (line1Picks[currTabIndex] != -1) {
					_loc2_ = game.gameData.characterCustomDefs[currTabIndex][int(line1Picks[currTabIndex]) + 2];
				} else {
					_loc1_ = false;
				}
				break;
			case 2:
				if (line1Picks[currTabIndex] != 0) {
					_loc2_ = game.gameData.characterCustomDefs[currTabIndex][int(line1Picks[currTabIndex]) + 1];
				} else {
					_loc2_ = [];
					itemClicked(-1, 2, -1);
					_loc1_ = false;
	...
	function setOrder(param1:Dynamic):Dynamic {
		var _loc2_:Int = undefined;
	...
	function playSlideInSound():Dynamic {
		clearInterval(playSlideInSoundInterval);
	...
	function setTab(param1:Dynamic):Dynamic {
		var _loc2_:Int = undefined;
		var _loc3_:Dynamic = undefined;
		var _loc4_:Dynamic = undefined;
		currTabIndex = param1;
	...
	function showMenuScreenCont():Dynamic {
		clearInterval(playSlideInSoundInterval);
		game.showMenuScreen();
	}

	function itemClicked(param1:Dynamic, param2:Dynamic, param3:Dynamic):Dynamic {
		var _loc4_:Dynamic = undefined;
		var _loc5_:Dynamic = undefined;
		var _loc6_:Dynamic = undefined;
		var _loc7_:Dynamic = undefined;
	...
	function emptyFramePicked():Dynamic {
		itemClicked(-1, 1, 0);
	}
	...
	function getItemPicked():Dynamic {
		...
		while (_loc3_ < 6) {
			...
			if (_loc4_ == 0) {
				...
				if (line2Picks[_loc3_] != -1) {
					_loc2_ = game.gameData.characterCustomDefs[_loc3_][int(line1Picks[_loc3_]) + 2][line2Picks[_loc3_]];
					_loc1_.push(_loc2_);
				}
			} else if (line2Picks[_loc3_] != -1) {
				_loc2_ = game.gameData.characterCustomDefs[_loc3_][int(line1Picks[_loc3_]) + 1][line2Picks[_loc3_]];
				_loc1_.push(_loc2_);
			}
			_loc3_++;
		}
	...
	function continueClicked(param1:MouseEvent):Void {
		if (!game.msgShown) {
			...
			if (currStage == 8) {
				...
				game.sound.playEffect("GENERAL_MENU_SLIDE_OUT");
				playSlideInSoundInterval = setInterval(startGameCont, 600);
	...
	function setTabData():Dynamic {
		var _loc1_:Dynamic = undefined;
		var _loc2_:Dynamic = undefined;
		var _loc3_:Array<Dynamic> = null;
		var _loc4_:Int = undefined;
		var _loc5_:Int = undefined;
		var _loc6_:Dynamic = undefined;
		var _loc7_:Dynamic = undefined;
