...
class BambaData {
	...
	function getCatalogSurprise(param1:Dynamic):BambaSurprise {
	...
	function buildDungeonsDataCatalog(param1:Array<Xml>):Dynamic {
		var _loc2_:Xml = null;
	...
	function loadDictionary(param1:Xml):Dynamic {
		dictionary.load(param1);
	}

	function getCatalogEnemyLevel(param1:Dynamic, param2:Dynamic):BambaEnemyLevel {
	...
	function buildEnemiesCatalog(param1:Array<Xml>):Dynamic {
		var _loc2_:Xml = null;
	...
	public function loadCharacterCustom(param1:Array<Xml>):Dynamic {
		var _loc2_:Xml = null;
		var _loc3_:Dynamic = undefined;
		var _loc4_:Dynamic = undefined;
		var _loc5_:Dynamic = undefined;
		var _loc6_:Int = undefined;
		var _loc7_:String = undefined;
	...
	function buildItemsCatalog(param1:Array<Xml>):Dynamic {
		var _loc2_:Xml = null;
	...
	function buildCardsCatalog(param1:Array<Xml>):Dynamic {
		var _loc2_:Xml = null;
		var _loc3_:BambaCard = null;
		for (_loc2_ in param1) {
	...
	public function loadOrdersStartDef(param1:Array<Xml>):Dynamic {
		var _loc2_:Xml = null;
		var _loc3_:Dynamic = undefined;
		var _loc4_:Dynamic = undefined;
		var _loc5_:Dynamic = undefined;
	...
	function loadGeneralData(param1:Xml):Dynamic {
		var _loc2_:Array<Xml> = null;
		var _loc3_:Dynamic = undefined;
		var _loc4_:Dynamic = undefined;
		var _loc5_:Dynamic = undefined;
		var _loc6_:Dynamic = undefined;
	...
	function getCatalogPrize(param1:Dynamic):BambaPrize {
		var _loc2_:Dynamic = undefined;
		_loc2_ = 0;
	...
	function buildStoreItemsCatalog(param1:Array<Xml>):Dynamic {
		var _loc2_:Xml = null;
	...
	function buildPlayerLevelsCatalog(param1:Array<Xml>):Dynamic {
		var _loc2_:Xml = null;
